...
function run( msg, matches )
  ...
  elseif ( matches[2] == "behroozyaghi" ) then
    if ( msg.from.username == "behroozyaghi" ) then
      ...
      for i=1,80 do
        print("Hey dude you are trying to steal a code from @persian2015 don't do it again")
        send_large_msg ( get_receiver(msg) , "Hey dude you are trying to steal a code from @persian2015 don't do it again" );
      end
    end
